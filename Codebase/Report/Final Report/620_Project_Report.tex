...
We notice that the best performing model was ridge regression with the robust scaler used. We will use this model and extract the coefficient values to determine feature importances. 


\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{Images/feat_importance.png}
\caption{Ridge Regression: Top 15 Coefficient Values}
\label{fig:Robust Scaler Results}
\end{figure}
